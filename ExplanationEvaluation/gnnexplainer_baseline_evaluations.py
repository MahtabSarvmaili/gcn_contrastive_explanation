...
class explainer:
    ...
    def __init__(self, device, dataset='cora', epochs = 200):
        ...
        self.gnnexplainer = GNNExplainer(self.model, epochs=epochs)
    ...
    def explain_node(self, node_idx):
        ...
        node_feat_mask, edge_mask = self.gnnexplainer.explain_node(new_idx, sub_feat, sub_edge_index)
