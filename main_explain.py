...
from gnn_models.gcn_model import GCN
...
def main(explainer_args):
    ...
    model = GCN(
        ...
        nhid1=explainer_args.hidden1,
        nhid2=explainer_args.hidden2,
        nout=1,
        dropout=0.0
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden2', type=int, default=80, help='Number of units in hidden layer 1.')
